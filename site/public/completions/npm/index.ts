// npm & npx 补全脚本 (文件夹模式 i18n，下划线键名)
// 运行 `sugg i18n-gen` 生成 i18n.d.ts
...
const provenanceOpt: OptionNode = {
  labels: ["--provenance", "--provenance-file"],
...
const searchOpts: OptionNode[] = [
  ...
  { labels: ["--color", "--no-color", "--color always"], description: t.opt_color },
...
const initOpts: OptionNode[] = [
  ...
  { labels: ["--no-workspaces-update"], description: t.opt_noWorkspacesUpdate },
];
...
const expectResultsOpt: OptionNode = {
  labels: ["--expect-results", "--expect-result-count"],
...
async function getInstalledPackages(): Promise<Suggestion[]> {
  ...
  return Object.keys(deps).map((name) => ({ display: name }));
}
  ...
  npm: {
    ...
    commands: {
      access: {
        ...
        commands: {
          ...
          set: {
            ...
            args: ["status=public|private", "mfa=none|publish|automation"],
          },
          grant: {
      ...
      bugs: {
        ...
        aliases: ["issues"],
        options: [browserOpt, registryOpt, workspaceOpt, workspacesOpt, includeRootOpt],
      ...
      cache: {
        ...
        commands: {
          ...
          clean: { description: t.cmd_cache_clean, args: [] },
      ...
      config: {
        ...
        commands: {
          set: { description: t.cmd_config_set, args: [] },
      ...
      exec: {
        ...
        args: dynamic(async (ctx) => getBinCommands(ctx)),
      },
      explain: {
      ...
      fund: {
        ...
        options: [jsonOpt, browserOpt, unicodeOpt, workspaceOpt, whichOpt],
        args: [],
      },
      get: {
      ...
      init: {
        ...
        options: [...initOpts, yesOpt, forceOpt, scopeOpt, workspaceOpt, workspacesOpt],
        args: [],
      },
      install: {
        ...
        args: dynamic(async (ctx) => {
          const [local, popular] = await Promise.all([
            scanPath(ctx.prefix),
            Promise.resolve([
              { display: "react", description: t.pkg_react },
              { display: "vue", description: t.pkg_vue },
              { display: "typescript", description: t.pkg_typescript },
              { display: "eslint", description: t.pkg_eslint },
              { display: "prettier", description: t.pkg_prettier },
            ]),
          ]);
      ...
      org: {
        ...
        commands: {
          set: {
            ...
            args: ["orgname", "username", "developer", "admin", "owner"],
          },
          rm: { description: t.cmd_org_rm, args: ["orgname", "username"] },
      ...
      owner: {
        ...
        commands: {
          add: {
            description: t.cmd_owner_add,
            args: [],
          },
          rm: { description: t.cmd_owner_rm, args: [] },
      ...
      pkg: {
        ...
        commands: {
          get: { description: t.cmd_pkg_get, args: [] },
          set: { description: t.cmd_pkg_set, args: [] },
          delete: { description: t.cmd_pkg_delete, args: [] },
      ...
      search: {
        ...
        aliases: ["find", "s", "se"],
        options: [jsonOpt, ...searchOpts, registryOpt],
        args: [],
      },
      set: {
      ...
      team: {
        ...
        commands: {
          ...
          add: { description: t.cmd_team_add, args: [] },
          rm: { description: t.cmd_team_rm, args: [] },
      ...
      version: {
        ...
        aliases: ["verison"],
        options: [...versionOpts, jsonOpt, workspaceOpt, workspacesOpt, includeRootOpt],
        args: [
          "major",
          "minor",
          "patch",
