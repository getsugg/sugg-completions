...
const scripts: ScriptInfo[] = [
  ...
  },
  {
    ...
    linesUrl: "./highlighted/scoop.json",
    staticAnalysis: JSON.parse(
  ...
  },
  {
    ...
    linesUrl: "./highlighted/sugg.json",
    staticAnalysis: JSON.parse("[]"),
  },
  {
    stem: "winget",
    ...
    linesUrl: "./highlighted/winget.json",
    staticAnalysis: JSON.parse(
